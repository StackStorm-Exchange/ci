...
COPYRIGHT_LICENSE_APACHE_PATTERN = re.compile(
    '                                 Apache License.*')
...
def update_copyright_python(filename, year):
    return update_copyright_st2_any(filename,
                                    year,
                                    COPYRIGHT_PY_ST2_PATTERN,
                                    COPYRIGHT_PY_ANY_PATTERN,
                                    COPYRIGHT_PY_ST2_FORMAT)
